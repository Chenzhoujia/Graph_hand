...
class ChemModel(object):
    ...
    def run_epoch(self, epoch_name, data, is_training):
        ...
        processed_graphs = 0
        make_minibatch_iterator_data = self.make_minibatch_iterator(data, is_training)
        batch_iterator = ThreadedIterator(make_minibatch_iterator_data, max_queue_size=5)
