...
def figure_joint_skeleton2(dm, uvd_pt,test_num,type):
    ...
    plt.savefig("/home/chen/Documents/denseReg-master/exp/train_cache/saved/pretrain/image/"+type+"/"+str(test_num).zfill(7)+"_"+type+".png")
