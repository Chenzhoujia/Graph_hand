...
class Evaluation(object):
    ...
    def plotError(cls_obj, score_list, fig_path):
        ...
        meanJntError_array = np.array(score_list)

        plt.savefig('/home/chen/Documents/denseReg-master/exp/train_cache/nyu_training_s2_f128_daug_um_v1/test'+str(np.nanmean(meanJntError_array))+'.png')
